...
RSpec.describe OSut do
  ...
  it "checks for space/surface convexity" do
    ...
    # ... no E+ errors/warnings.
    #
    # mini3.osm A  FullInteriorAndExterior                 253 GJ 3.5 UMH cool
    # mini3.osm B  FullExteriorWithReflections             254 GJ 3.3 UMH cool
    # mini3.osm C  FullInteriorAndExteriorWithReflections  254 GJ 3.3 UMH cool
  end
  ...
  it "checks generated skylight wells" do
    ...
    if OpenStudio.openStudioVersion.split(".").join.to_i > 300
      ...
      # single individual well leading down to "Core_ZN". Each (sloped) skylight
      ...
      # polygons relying on the OpenStudio::Transformation class.
